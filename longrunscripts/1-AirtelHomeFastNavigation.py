...
try:
    ...
    while 1:
        try:
            ...
            commonActions.click_home(filename, device, 10)
            # commonActions.continue_press(filename, device, "DPAD_RIGHT", 1)
            ...
            for l in range(0, 5):
                ...
                for row in range(RowsBetweenBanners):
                    commonActions.continue_press(filename, device, "DPAD_RIGHT", 2)
                    commonActions.press_key(filename, device, "DPAD_DOWN", 1,"Down key: Moving to next row")
