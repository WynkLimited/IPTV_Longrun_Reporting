...
while 1:
    ...
    commonActions.continue_press(filename, device, "DPAD_DOWN", menu_count)

    # Navigate to APPS by pressing right key from search in menu
    commonActions.continue_press(filename, device, "DPAD_RIGHT", 5)
    ...
    # Selecting Hotstar app
    commonActions.press_key(filename, device, "DPAD_CENTER", 300, "Selection key is pressed on hotstar app")
